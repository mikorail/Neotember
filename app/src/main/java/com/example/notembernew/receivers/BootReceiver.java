...
import com.example.notembernew.ui.SettingsActivity;
...
public class BootReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (context.getSharedPreferences(Constants.PREFS, MODE_PRIVATE).getBoolean(Constants.QUICK_NOTIFY, false)) {
            ...
            Intent checklistIntent = new Intent(context, ActivityChecklist.class);
            TaskStackBuilder stackBuilder1 = TaskStackBuilder.create(context);
            stackBuilder1.addParentStack(ActivityChecklist.class);
