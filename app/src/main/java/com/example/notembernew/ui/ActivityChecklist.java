...
import com.example.notembernew.receivers.AlarmReceiver;
...
public class ActivityChecklist extends AppCompatActivity {
        ...
        reminderSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if (!b) {
                    ...
                    DatePickerDialog datePickerDialog = new DatePickerDialog(ActivityChecklist.this,
                            new DatePickerDialog.OnDateSetListener() {
                                ...
                                public void onDateSet(DatePicker datePicker, final int year, final int month, final int day) {
                                    if (noOfTimesCalledDate % 2 == 0) {
                                        new TimePickerDialog(ActivityChecklist.this,
                                                    ...
                                                    public void onTimeSet(TimePicker timePicker, int hour, int min) {
                                                        if (noOfTimesCalledTime % 2 == 0) {
                                                            ...
                                                            if (calendar.compareTo(Calendar.getInstance()) <= 0) {
                                                                Toast.makeText(ActivityChecklist.this, R.string.invalid_time, Toast.LENGTH_SHORT).show();
                                                                return;
                                                            }
                                                ...
                                                }, calendar.get(Calendar.HOUR_OF_DAY), calendar.get(Calendar.MINUTE), DateFormat.is24HourFormat(ActivityChecklist.this)).show();
                                        noOfTimesCalledDate++;
                                    }
                                }
                            },
    ...
    public void notif(int notified) {
        ...
        if (notified == 0) {
            ...
            Intent resultIntent = new Intent(this, ActivityChecklist.class);
            Bundle bundle = new Bundle();
            bundle.putInt(NotesDB.Note._ID, id);
            bundle.putString(NotesDB.Note.COLUMN_NAME_TITLE, title);
            bundle.putString(NotesDB.Note.COLUMN_NAME_SUBTITLE, subtitle);
            ...
            stackBuilder.addParentStack(ActivityChecklist.class);
